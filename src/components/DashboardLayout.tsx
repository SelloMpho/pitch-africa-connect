...
const roleConfig = {
  admin: {
    ...
    navItems: [
      ...
      { label: "Verifications", icon: ShieldCheck, href: "/dashboard/admin/verifications" },
      { label: "Platform Analytics", icon: BarChart3, href: "/dashboard/admin/analytics" },
      { label: "Reports & Fraud", icon: FileWarning, href: "/dashboard/admin/reports" },
      { label: "Content", icon: FileText, href: "/dashboard/admin/content" },
  ...
  entrepreneur: {
    ...
    navItems: [
      ...
      { label: "Pitch Deck", icon: Presentation, href: "/dashboard/entrepreneur/pitch" },
      { label: "Funding Applications", icon: Wallet, href: "/dashboard/entrepreneur/applications" },
      { label: "Browse Investors", icon: Search, href: "/dashboard/entrepreneur/investors" },
      { label: "Messages", icon: MessageSquare, href: "/dashboard/entrepreneur/messages" },
      { label: "Analytics", icon: BarChart3, href: "/dashboard/entrepreneur/analytics" },
  ...
  investor: {
    ...
    navItems: [
      ...
      { label: "Discover Startups", icon: Search, href: "/dashboard/investor/discover" },
      { label: "Saved Pitches", icon: Bookmark, href: "/dashboard/investor/saved" },
      { label: "My Portfolio", icon: Briefcase, href: "/dashboard/investor/portfolio" },
      { label: "Deal Flow", icon: TrendingUp, href: "/dashboard/investor/deals" },
      { label: "Messages", icon: MessageSquare, href: "/dashboard/investor/messages" },
      { label: "Analytics", icon: BarChart3, href: "/dashboard/investor/analytics" },
